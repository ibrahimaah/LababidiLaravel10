...
Route::middleware(['cookie'])->group(function () {
    ...
    Route::post('/about/store', 'App\Http\Controllers\AboutController@store')->name('store-about');
    Route::get('/about/edit', 'App\Http\Controllers\AboutController@edit')->name('edit-about');
    Route::post('/about/update', 'App\Http\Controllers\AboutController@update')->name('update-about');
    Route::post('/about/remove/{id}', 'App\Http\Controllers\AboutController@destroy')->name('remove-about');
    ...
    Route::get('/admin/social-media-link', 'App\Http\Controllers\SocialMediaLinkController@index')->name('admin-social-media-link');
